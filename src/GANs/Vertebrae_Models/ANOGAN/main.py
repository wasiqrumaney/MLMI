...
if __name__ == '__main__':
    ...
    #ANOGAN params 
    parser.add_argument('--train_ano', type=float, default=10000,
                        help='epochs to train ANOGAN')
    parser.add_argument('--ANO', type=str2bool, default=True,
                        help='flag if to do anomaly detection or train gan')	
    # Model Parmeters
    parser.add_argument('--n_epochs', type=float, default=1000,
                        help='max epochs')
    parser.add_argument('--batch_size', type=float, default=64, ###
                        help='each batch size')
    parser.add_argument('--g_lr', type=float, default=0.00025,
                        help='generator learning rate')
    parser.add_argument('--d_lr', type=float, default=1e-2, #1e-3
    ...
    parser.add_argument('--leak_value', type=float, default=0.2,
                        help='leakeay relu')
    parser.add_argument('--cube_len', type=float, default=64, #i changed this from 32 to 64
                        help='cube length')
